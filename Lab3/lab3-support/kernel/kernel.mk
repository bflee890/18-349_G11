...
KOBJS := assert.o main.o raise.o setup.o s_handler.o i_handler.o c_swi_handler.o c_irq_handler.o write.o read.o exit.o time.o sleep.o incStack.o irq_stack.o 
KOBJS := $(KOBJS:%=$(KDIR)/%)
